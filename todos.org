...
* todos
- [ ] mobile: include fonts (or use system fonts)
- [ ] Use SvelteKit version as main version
     - We could then do the searching on the server side and avoid having to build 170000+ pages
- [ ] gzip titles.json during build & decode in JS
...
- [-] Incorporate Ministry of Education's Hakka dictionary
  ...
  - [ ] Write the word template code for it
